...
**Шаблон внесения изменений:**

1. Зайти на репозиторий проекта.
2. Скачать на компьютер репозиторий с проектом.
3. Создать локальную ветку для внесения изменений.
4. Внести изменения.
5. Сохранить изменения.
6. Внести изменения в локальную историю репозитория.
7. Отправить изменения на удаленный репозиторий.
8. Открыть pull request (сессия ревью на github) из ветки с изменениями в главную ветку.
9. Пройти CI (автоматический запуск unit тестов, code coverage) проверку.
10. Пригласить всех членов команды к изучению изменений.
11. Получить одобрение на слияние изменений в главную ветку от каждого члена команды.
12. Слить ветку, в которую внесены изменения, с главной веткой проекта.
13. Удалить ветку, в которую были внесены изменения.
...
-->
Внедрение, в данном сучае, представляет из себя комплиляцию исходного кода в исполняемый файл приложения, после чего данный файл может быть передан для запуска на системе заказчика. Компиляция исходного кода может производиться как вручную (через формирование необходимого окружения и запуск компилятора в терминале), так и через утилиту JAnt, которая будет конфигурировать необходимое окружение и запускать компилятор в этом окружении. Исполняемый файл, при передаче заказчику должен сопровождаться документацией по исползованию данного сервиса.
...
- **Среда разработки - IntelliJIdea 2018**

Удобная, развивающаяся, мощная, IDE, разрабатываемая компанией JetBrains, отлично подходит для разработки, компиляции, сборки, отладки и тестирования продуктов на Java. При условии открытия исходного кода приложения, разрешается использовать для разработки бесплатную Community версию. Выбран по вышеописанным причинам, а так же по наличию опыта работы с этим инструментом у каждого члена команды.
...
- **Unit Tests Framework - JUnit**

Стандартный юнит тест фреймворк JUnit, является очевидным решением, так как он наиболее распространен, а также регулярно обновляется и задокументирован. Выбран, так как является стандартным инструментом, для используемого командой IDE.
