...
-->
Инсталляция, в данном случае, представляет из себя запуск исполняемого файла приложения на системе заказчика. Деинсталляция представляет собой клиентского исполняемого файла приложения. В этот момент производится локальное удаление всех сборок.
