...
* Не будет реализован бекап ( возможность восстановить систему при её сбое ) системы. Потребуются существенные денежные траты на создание резервной копии базы данных. Также настройка периодической системы создания бекапов потребует дополнительного времени, потраченного на разработку.
...
Предположение:
* Здесь стоит представить диаграмму взаимодействия классов
* В предположениях стоит написать, как классы будут взаимодействовать
* А так же некоторые функции, возможные алгоритмы...
