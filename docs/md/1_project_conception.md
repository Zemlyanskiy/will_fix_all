...
| Description | Отображение текущей заняости мастеров и свободного времени работы  |
| Priority    | 1  |
| Source      | Техническое задание |
| Risk        | 1  |
| Referense   | E005, E009  |
...
|-------------|---|
| Group       | Общие возможности  |
| Description | Выход из своей учетной записи. После выхода клиент имеет возможность пользоваться программой только как неавторизированный пользователь  |
| Priority    | 1  |
| Source      | Техническое задание |
| Risk        | 1  |
| Referense   | E007, E008  |
...
|-------------|---|
| Group       | Регистрация |
| Description | Проверка введённого пользователем email на валидность( правильность ). Email имеет стандартный вид: логин@доменное имя сервера  |
| Priority    | 1  |
| Source      | Техническое задание |
| Risk        | 1  |
| Referense   | F001  | 
...
|-------------|---|
| Group       | Общие возможности. Авторизация |
| Description | При неверном email + пароль при авторизации, либо при неверном пароле, должна появляться ошибка "Проверьте правильность ввода email и пароля"   |
| Priority    | 1  |
| Source      | Техническое задание |
| Risk        | 1  |
| Referense   | F002  | 
...
|-------------|---|
| Group       | Общие возможности |
| Description | При выборе для диагностики занятого времени, должна появляться ошибка, о занятости этого времени и просьба выбрать другое время  |
| Priority    | 1  |
| Source      | Техническое задание |
| Risk        | 1  |
| Referense   | F004  | 
