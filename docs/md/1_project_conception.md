...
Менеджер будет иметь возможность связаться с клиентом с помощью встроенного в приложение чата. С помощью него возможно будут уточнить некоторые детали работы связанные с автомобилем клиента.
